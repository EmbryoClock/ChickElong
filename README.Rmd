...
2. To inspect the data analysis performed, just download and open the .html files from each analysis in your favorite browser: `chick_elong_[analysis_name].html`.
